...
function RoleBtn({ active, icon, label, onClick }) {
  return (
    <button onClick={onClick} style={{ width: 118, height: 76, borderRadius: 10, border: active ? "2px solid #2E7D32" : "1px solid #DDDDDD", background: active ? "#F5FBF6" : "white", color: active ? "#2E7D32" : "#424242", cursor: "pointer", fontFamily: "Poppins", fontWeight: 700, fontSize: 13 }}>
