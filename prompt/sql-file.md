# BAGO.PH — SQL File Instruction Prompt
## bago_ph_database.sql
...
Write tables in this order. Foreign keys reference tables that are created before them.
...
### TABLE 7 — eco_points_transactions
...
Write at least 5 rows per table. Use real Lipa City barangay names.
...
- [ ] File imports cleanly into phpMyAdmin or MySQL Workbench with no errors